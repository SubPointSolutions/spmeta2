                            ...
                            .AddList(AppListModels.CompanyDepartments, list =>
                            {
                                list
                                    ...
                                    .AddWebPartPage(AppWebPartPageModels.RootWeb.SitePages.AboutFounationApp, page =>
                                    {
                                        page
                                            .AddWebPart(
                                                AppWebPartsModels.RootWeb.SitePages.AboutFounationAppPage.AboutUsWebPart)
                                            .AddWebPart(
                                                AppWebPartsModels.RootWeb.SitePages.AboutFounationAppPage
                                                    .OurDepartmentsWebPart)
                                            .AddWebPart(
                                                AppWebPartsModels.RootWeb.SitePages.AboutFounationAppPage
                                                    .OurServicesWebPart);
                                    });
