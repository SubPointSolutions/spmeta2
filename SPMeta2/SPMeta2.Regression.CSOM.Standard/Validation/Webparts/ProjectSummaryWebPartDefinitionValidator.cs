...
{
    public class ProjectSummaryWebPartDefinitionValidator : WebPartDefinitionValidator
    {
        ...
        public override void DeployModel(object modelHost, DefinitionBase model)
        {
            ...
            var definition = model.WithAssertAndCast<ProjectSummaryWebPartDefinition>("model", value => value.RequireNotNull());
