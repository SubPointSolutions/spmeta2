...
{
    public abstract class ContentFileModelHandlerBase : CSOMModelHandlerBase
    {
        #region properties
        ...
        protected ContentPageDefinitionBase CurrentModel { get; set; }
        ...
        protected abstract void MapProperties(object modelHost, ListItem item, ContentPageDefinitionBase definition);
