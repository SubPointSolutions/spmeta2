...
{
    //public abstract class ContentPageModelHandlerBase : CSOMModelHandlerBase
    //{
    //    #region properties
    ...
    //        var definition = model.WithAssertAndCast<PageItemDefinitionBase>("model", value => value.RequireNotNull());
    ...
    //    protected abstract void MapProperties(object modelHost, ListItem item, ContentFileDefinitionBase definition);
