...
namespace SPMeta2.Standard.Syntax
{
    public static class RefinementScriptWebPartDefinitionSyntax
    {
        ...
        public static TModelNode AddProjectSummaryWAddRefinementScriptWebPartebPart<TModelNode>(this TModelNode model, RefinementScriptWebPartDefinition definition)
