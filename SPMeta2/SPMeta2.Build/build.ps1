...
& $msbuild_path """$solutionRootPath\SPMeta2.CSOM\SPMeta2.CSOM.Behaviours.csproj"" /t:Clean,Rebuild /p:Configuration=Debug40 /p:Platform=AnyCPU /p:WarningLevel=0"
& $msbuild_path """$solutionRootPath\SPMeta2.CSOM\SPMeta2.CSOM.Behaviours.csproj"" /t:Clean,Rebuild /p:Configuration=Debug45 /p:Platform=AnyCPU /p:WarningLevel=0"
...
& $msbuild_path """$solutionRootPath\SPMeta2.CSOM.Standard\SPMeta2.CSOM.Standard.Behaviours.csproj"" /t:Clean,Rebuild /p:Configuration=Debug40 /p:Platform=AnyCPU /p:WarningLevel=0"
& $msbuild_path """$solutionRootPath\SPMeta2.CSOM.Standard\SPMeta2.CSOM.Standard.Behaviours.csproj"" /t:Clean,Rebuild /p:Configuration=Debug45 /p:Platform=AnyCPU /p:WarningLevel=0"
...
& $msbuild_path """$solutionRootPath\SPMeta2.SSOM\SPMeta2.SSOM.Behaviours.csproj"" /t:Clean,Rebuild /p:Configuration=Debug40 /p:Platform=AnyCPU /p:WarningLevel=0"
& $msbuild_path """$solutionRootPath\SPMeta2.CSOM\SPMeta2.SSOM.Behaviours.csproj"" /t:Clean,Rebuild /p:Configuration=Debug45 /p:Platform=AnyCPU /p:WarningLevel=0"
