...
{
    public class HtmlMasterPageDefinitionValidator : HtmlMasterPageModelHandler
    {
        public override void DeployModel(object modelHost, DefinitionBase model)
        {
            ...
            var associatedMasterPage = GetCurrentObjectByPageName(folder, associatedMasterPageName);
            ...
            assert.ShouldBeEqual((p, s, d) =>
            {
                ...
                // cannot company the content, always slightly different
                //isContentValid = dstStringContent.Contains(srcStringContent);

                // length change is more realiztic check
