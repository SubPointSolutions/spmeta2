...
{
    public class AudienceModelHandler : SingleHostTypedSSOMModelHandlerBase<SiteModelHost, AudienceDefinition, Audience>
    {
        ...
        protected override void UpdateObject(Audience currentObject)
        {
        ...
        protected override void MapObject(Audience currentObject, AudienceDefinition definition)
        {
