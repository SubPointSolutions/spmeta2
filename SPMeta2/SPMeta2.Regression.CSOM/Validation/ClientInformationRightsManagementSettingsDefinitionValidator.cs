...
{
    public class ClientInformationRightsManagementSettingsDefinitionValidator : InformationRightsManagementSettingsModelHandler
    {
        #region methods
        ...
        public override void DeployModel(object modelHost, DefinitionBase model)
        {
            ...
            // // SSOM hardcoded value, reflection
            ...
            else
            {
                assert.ShouldBeEqual((p, s, d) =>
                {
                    ...
                    var isValid =
                        ...
                        // SSOM hardcoded value, reflection
                        d.LicenseCacheExpireDays == 30 ||
                        // CSOM regular one
                        s.LicenseCacheExpireDays == d.LicenseCacheExpireDays;
